...
VENV_NAME="gpxdot-env"
SCRIPT_NAME="gpxdot.py"

# 1. Vérifier et installer Python3 et pip si nécessaire
echo "[1/5] Vérification de Python et pip..."
...
# 2. Vérifier si venv est dispo, sinon l’installer
...
echo "[2/5] Création de l'environnement virtuel '$VENV_NAME'..."
python3 -m venv "$VENV_NAME"

# 4. Activer l'environnement et installer gpxpy et geopy
echo "[3/5] Activation de l'environnement et installation de gpxpy..."
...
echo "[4/5] Création du script Python '$SCRIPT_NAME'..."
cat > "$SCRIPT_NAME" << 'EOF'
#!/usr/bin/env python3
...
echo "  python $SCRIPT_NAME trace.gpx 50"
echo "  deactivate  # pour sortir de l'environnement"